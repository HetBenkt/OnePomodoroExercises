...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 4 days exercises! [CHEST{5} & TRICEPS{4}]', '2019-1-7'   , ARRAY[-2,-3,25,26,28, 52,401,501,402,57,404,    29,86,5,103,201,46,-30]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way! [BEG{3} & BICEPS{1}]', '2019-1-9'                    , ARRAY[-2,-3,25,26,28, 4,105,302,103,84,102,301, 18,6,403,202,44,-40]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Half way done! [LEGS{0} & SHOULDERS{2}]', '2019-1-11'                 , ARRAY[-2,-3,25,26,28, 34,203,71,201,76,202,67,  30,5,102,404,49,-50]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 4', 'Finish the sequence as a pro! [BICEPS{1} & TRICEPS{4}]', '2019-1-12'  , ARRAY[-2,-3,25,26,28, 105,402,103,401,101,403,  19,86,6,201,501,44,-60]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (34, '2 x 5kg Lunges'                 , 'td_action_img/lunge/icon.png'                      , 1, '30 days Legs'   , 3, 16, 'times', 'Stand straight, put hands on hips; take step forward and lower body until thigh is parallel with floor. Return and switch to other leg');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (67, '2 x 5kg Calf raise'             , 'td_action_img/single_leg_calf_raise_right/icon.png', 1, '30 days Legs'   , 3, 18, 'times', 'Stand with arms against the wall; Put your right foot on your left enkle, then lift your heel up and down; now switch foot and repeat');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (71, '2 x 5kg Squats'                 , 'td_action_img/squat/icon.png'                      , 1, '30 days Legs'   , 3, 12, 'times', 'Stand wide and arms stretched forward; lower body till thighs are parallel with floor; return to start position and repeat');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (76, '2 x 5kg Squats split left/right', 'td_action_img/split_squat_right/icon.png'          , 1, '30 days Legs'   , 3,  7, 'times', 'Take a big step foreward and keep body straight; lower body and go back up; repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (86, '1 x 2.5kg Triceps with chair'   , 'td_action_img/triceps_dip_on_chair/icon.png'       , 1, '30 days Triceps', 1, 22, 'times', 'Sit on chai and move your hip off the chai with your hands holding the chair edge; Slowly bend and stretch arms to make your body go up and down');

INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (101, '2 x 5kg Curls sitting'           , 'exicons/2.png' , 1, 'DB Biceps'   ,3, 18, 'times', 'Sit on chair; keep elbows close to body and palms towards legs; do not move upper arm; raise hand to shoulder; rotate arm when palms facing to shoulder');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (102, '2 x 5kg Curls standing '         , 'exicons/1.png' , 1, 'DB Biceps'   ,3, 18, 'times', 'Stand straight; keep elbows close to body and palms towards legs; do not move upper arm; raise hand to shoulder; rotate arm when palms facing to shoulder');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (103, '1 x 5kg Curls conc. left/right'  , 'exicons/4.png' , 1, 'DB Biceps'   ,3, 18, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (201, '2 x 5kg Side raise'              , 'exicons/11.png', 1, 'DB Shoulders',3, 12, 'times', 'Stand straight and slightly bend elbows; slowly upper arms sidewards until head level; hold 1 sec. and return and repeat');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (202, '2 x 5kg Front raise'             , 'exicons/26.png', 1, 'DB Shoulders',3, 12, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (203, '2 x 5kg Seated press'            , 'exicons/9.png' , 1, 'DB Shoulders',3, 14, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (301, '2 x 5kg Shoulder shrug'          , 'exicons/14.png', 1, 'DB Beg'      ,3, 18, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (302, '2 x 5kg Renegade rows'           , 'exicons/15.png', 1, 'DB Beg'      ,3, 12, 'times', '');
