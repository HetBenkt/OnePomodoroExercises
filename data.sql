...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days exercises!', '2018-8-14', ARRAY[-2,4,15,18,19,22,34,39,44,52,57,67,70,76,103,104,105,107,109,-3]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2018-8-15'              , ARRAY[-2,5,10,16,25,29,34,49,52,58,66,71,84,88,101,102,103,106,110,-4]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2018-8-16' , ARRAY[-2,6,17,19,25,29,38,46,54,58,66,71,86,89,101,102,105,106,108,-3]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 4', 'Your day off as earned!', '2018-8-17'       , ARRAY[-1]);
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (10, 'Burpees easy', 'Stand wide, put hands on the ground, kick feet backwards, do push-up, stand up and jump', 'td_action_img/burpee/icon.png', 1, '30 days', 1, 9, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (19, 'Firehydrant left/right', 'Sit on knees; knees under your butt; hands under shoulders; Lift leg to the side at 90 degree angle', 'td_action_img/fire_hydrant_right/icon.png', 1, '30 days', 1, 18, 'times');
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (22, 'High stepping', 'Run in place while pulling knees as high as possible with each step; keep upper body upright', 'td_action_img/high_knees/icon.png', 1, '30 days', 1, 44, 'times');
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (25, 'Jumping jacks', 'Start with your feet together and arms by your sides; jump up with feet apart and hands overhead; return to start and repeat', 'td_action_img/jumping_jacks/icon.png', 1, '30 days', 1, 64, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (34, 'Lunges', 'Stand straight, put hands on hips; take step forward and lower body until thigh is parallel with floor. Return and switch to other leg', 'td_action_img/lunge/icon.png', 1, '30 days', 1, 22, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (66, 'Russian twist', 'Sit tilted back on the floor with knees bent and feet lifted; Hold hands together and twist from side to side', 'td_action_img/russian_twist/icon.png', 1, '30 days', 1, 34, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (101, 'Curls sitting', 'Sit on chair; keep elbows close to body and palms towards legs; do not move upper arm; raise hand to shoulder; rotate arm when palms facing to shoulder', 'exicons/2.png', 1, 'Dumbbells', 3, 7, 'times');
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (102, 'Curls standing', 'Stand straight; keep elbows close to body and palms towards legs; do not move upper arm; raise hand to shoulder; rotate arm when palms facing to shoulder', 'exicons/1.png', 1, 'Dumbbells', 3, 7, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (107, 'Tricep extension', '', 'exicons/6.png', 1, 'Dumbbells', 3, 7, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (109, 'Front ups left/right', '', 'exicons/26.png', 1, 'Dumbbells', 3, 7, 'times');
