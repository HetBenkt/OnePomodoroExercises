...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days FULL-BODY exercises!', '2019-5-20', ARRAY[-2,-3,26,  105,  203,  67,   52,    4,301,  34,   5,  19,  201,  102,  401,  41,  46,  -30]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2019-5-22'                        , ARRAY[-2,-3,28,  102,  201,  69,  501,  302, 86,  71,   6,  29,  202,  103,  403,  42,  44,  -40]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2019-5-24'           , ARRAY[-2,-3,25,  103,  202,  68,  502,   84, 86,  76,  18,  30,  203,  105,  404,  43,  49,  -50]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (43, '1 x 11kg Side Bends left/right' , 'td_action_img/empty/icon.png'                      , 1, '30 days Abs'       , 3, 10, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (71, '2 x 8,5kg Squats'               , 'td_action_img/squat/icon.png'                      , 1, '30 days Quadri.'   , 3,  8, 'times', 'Stand wide and arms stretched forward; lower body till thighs are parallel with floor; return to start position and repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (86, '1 x 7kg Triceps with chair'     , 'td_action_img/triceps_dip_on_chair/icon.png'       , 1, '30 days Triceps'   , 1, 15, 'times', 'Sit on chair and move your hip off the chai with your hands holding the chair edge; Slowly bend and stretch arms to make your body go up and down');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (103, '1 x 10kg Curls conc. left/right' , 'exicons/4.png'                , 1, 'DB Biceps'   ,3,  8, 'times', '');
