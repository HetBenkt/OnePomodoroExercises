...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days FULL-BODY exercises!', '2019-11-25', ARRAY[-2,-3,26,24,   201,          34,            102,       67,        40,     401,        18,        5,             501,        4,     44,    -30]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2019-11-27'                        , ARRAY[-2,-3,28,24,   202,          71,            105,       68,        42,     404,        19,        6,              52,      301,     46,    -40]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2019-11-29'           , ARRAY[-2,-3,25,24,   203,          76,            103,       69,        43,     403,        29,        7,             502,      302,     49,    -50]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (49, 'Plank straight-arms'            , 'td_action_img/straight_arm_plank/icon.png'         , 1, '30 days Abs'       , 1,105, 'sec', 'Lie straight with both arms stretched supporting body; hold position');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (302, '1 x 11kg Dumbbell rows (L)/(R)'  , 'exicons/15.png'               , 1, 'DB Back'     ,3,  9, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (401, '1 x 8,5kg Kickbacks (L)/(R)'     , 'exicons/8.png'                , 1, 'DB Triceps'  ,3,  8, 'times', 'Lean with one knee and elbow on table; kickback your arm, return and repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (404, '2 x 8,5kg French press'          , 'exicons/7.png'                , 1, 'DB Triceps'  ,3,  8, 'times', '');
