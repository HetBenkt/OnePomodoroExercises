...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days FULL-BODY exercises!', '2019-6-10', ARRAY[-2,-3,26,  105,  203,  67,   52,    4,301,  34,   5,  19,  201,  101,  401,  41,  46,  -30]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2019-6-12'                        , ARRAY[-2,-3,28,  102,  201,  69,  501,  302, 86,  71,   6,  29,  202,  103,  403,  42,  44,  -40]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2019-6-14'           , ARRAY[-2,-3,25,  103,  202,  68,  502,   84, 86,  76,  18,  30,  203,  101,  404,  43,  49,  -50]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (71, '2 x 8,5kg Squats'               , 'td_action_img/squat/icon.png'                      , 1, '30 days Quadri.'   , 3, 11, 'times', 'Stand wide and arms stretched forward; lower body till thighs are parallel with floor; return to start position and repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (301, '2 x 8,5kg Shoulder shrug'        , 'exicons/14.png'               , 1, 'DB Back'     ,3, 12, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (403, '1 x 7kg One arm press left/right', 'exicons/5.png'                , 1, 'DB Triceps'  ,3, 12, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (501, '2 x 8,5kg Press on floor'        , 'exicons/25.png'               , 1, 'DB Chest'    ,3, 14, 'times', '');
