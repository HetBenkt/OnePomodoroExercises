...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days FULL-BODY exercises!', '2019-12-16', ARRAY[-2,-3,26,24,   201,          34,            102,       67,        40,     401,        18,        5,             501,        4,     44,    -30]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2019-12-18'                        , ARRAY[-2,-3,28,24,   202,          71,            105,       68,        42,     404,        19,        6,              52,      301,     46,    -40]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2019-12-20'           , ARRAY[-2,-3,25,24,   203,          76,            103,       69,        43,     403,        29,        7,             502,      302,     49,    -50]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (40, 'BC Bicycles'                    , 'td_action_img/empty/icon.png'                      , 1, 'Abs'               , 3, 18, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (103, '1 x 10kg Curls conc. (L)/(R)'    , 'exicons/4.png'                , 1, 'DB Biceps'   ,3, 13, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (302, '1 x 11kg Dumbbell rows (L)/(R)'  , 'exicons/15.png'               , 1, 'DB Back'     ,3, 10, 'times', '');
