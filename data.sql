...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days exercises!', '2018-8-6', ARRAY[-2,4,15,18,19,22,34,39,44,52,57,67,70,76,103,104,105,107,109,-3]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2018-8-7'              , ARRAY[-2,5,10,16,25,29,46,49,52,58,66,71,84,88,101,102,103,106,110,-4]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2018-8-8' , ARRAY[-2,6,17,19,25,29,34,38,54,58,66,71,86,89,101,102,105,106,108,-3]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 4', 'Your day off as earned!', '2018-8-9'       , ARRAY[-1]);
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (22, 'High stepping', '', 'td_action_img/high_knees/icon.png', 1, '30 days', 1, 40, 'times');
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (25, 'Jumping jacks', '', 'td_action_img/jumping_jacks/icon.png', 1, '30 days', 1, 60, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (66, 'Russian twist', '', 'td_action_img/russian_twist/icon.png', 1, '30 days', 1, 30, 'times');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (88, 'Wallclimbing', '', 'td_action_img/mountain_climber/icon.png', 1, '30 days', 1, 40, 'times');
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (89, 'Wallsit', '', 'td_action_img/wall_sit/icon.png', 1, '30 days', 1, 30, 'sec');
...
INSERT INTO exercises (excelrow, name, description, image, weight, category, sets, reps, units) VALUES (103, 'Curls concentration left/right', '', 'exicons/4.png', 1, 'Dumbbells', 3, 6, 'times');
...
SELECT d.title, e.category, e.name, e.excelrow from exercises e, days d where e.excelrow = ANY(d.exercises) and e.category = 'Dumbbells' order by d.title, e.excelrow
