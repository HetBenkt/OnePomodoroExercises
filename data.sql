...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days FULL-BODY exercises!', '2019-11-4', ARRAY[-2,-3,26,24,   201,          34,            102,       67,        40,     401,        18,        5,             501,        4,     44,    -30]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2019-11-6'                        , ARRAY[-2,-3,28,24,   202,          71,            105,       68,        42,     404,        19,        6,              52,      301,     46,    -40]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2019-11-8'           , ARRAY[-2,-3,25,24,   203,          76,            103,       69,        43,     403,        29,        7,             502,      302,     49,    -50]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (44, 'Plank'                          , 'td_action_img/plank/icon.png'                      , 1, '30 days Abs'       , 1, 90, 'sec', 'Lie straight with both forearms supporting body; hold position');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (46, 'Plank side (L)/(R)'             , 'td_action_img/right_side_plank/icon.png'           , 1, '30 days Abs'       , 1, 45, 'sec', 'Lie on side with forearm supporting body; hold position');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (67, '2 x 10kg Calf raise'            , 'td_action_img/single_leg_calf_raise_right/icon.png', 1, '30 days Calves'    , 3, 16, 'times', 'Stand with arms against the wall; Put your right foot on your left enkle, then lift your heel up and down; now switch foot and repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (76, '2 x 10kg Squats split (L)/(R)'  , 'td_action_img/split_squat_right/icon.png'          , 1, '30 days Quadri.'   , 3,  9, 'times', 'Take a big step forward and keep body straight; lower body and go back up; repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (105, '2 x 10kg Hammer'                 , 'exicons/3.png'                , 1, 'DB Biceps'   ,3, 13, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (202, '2 x 7kg Front raise'             , 'exicons/26.png'               , 1, 'DB Shoulders',3,  9, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (302, '1 x 10kg Dumbbell rows (L)/(R)'  , 'exicons/15.png'               , 1, 'DB Back'     ,3, 11, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (401, '1 x 7kg Kickbacks (L)/(R)'       , 'exicons/8.png'                , 1, 'DB Triceps'  ,3, 11, 'times', 'Lean with one knee and elbow on table; kickback your arm, return and repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (501, '2 x 10kg Press on floor'         , 'exicons/25.png'               , 1, 'DB Chest'    ,3, 15, 'times', '');
