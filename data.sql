...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 4 days exercises! [CHEST & TRICEPS]', '2018-12-3', ARRAY[-2,25,52,104,115,107,57,113,29,86,5,103,106,46,-3]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way! [BEG & BICEPS]', '2018-12-5'                 , ARRAY[-2,25,4,105,114,103,84,102,111,18,6,112,109,44,-4]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Half way done! [LEGS & SHOULDERS]', '2018-12-7'               , ARRAY[-2,25,34,110,71,106,76,109,67,30,5,102,113,49,-5]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 4', 'Finish the sequence as a pro! [BICEPS & TRICEPS]', '2018-12-8', ARRAY[-2,25,105,107,103,104,101,112,19,86,6,106,115,44,-6]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (4 , 'Bird-dog'                    , 'td_action_img/bird_dog/icon.png'                   , 1, '30 days Beg'    , 1, 42, 'times', 'Sit on knees; knees under your butt; hands under shoulders; Stretch right leg en left arm at the same time; hold 5 sec. and repeat other side');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (71, 'Squats'                      , 'td_action_img/squat/icon.png'                      , 1, '30 days Legs'   , 3,  8, 'times', 'Stand wide and arms stretched forward; lower body till thighs are parallel with floor; return to start position and repeat');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (101, 'Curls sitting'                 , 'exicons/2.png' , 1, 'DB Biceps'   ,3, 12, 'times', 'Sit on chair; keep elbows close to body and palms towards legs; do not move upper arm; raise hand to shoulder; rotate arm when palms facing to shoulder');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (102, 'Curls standing '               , 'exicons/1.png' , 1, 'DB Biceps'   ,3, 12, 'times', 'Stand straight; keep elbows close to body and palms towards legs; do not move upper arm; raise hand to shoulder; rotate arm when palms facing to shoulder');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (103, 'Curls concentration left/right', 'exicons/4.png' , 1, 'DB Biceps'   ,3, 12, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (105, 'Hammer'                        , 'exicons/3.png' , 1, 'DB Biceps'   ,3, 12, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (106, 'Side raise'                    , 'exicons/11.png', 1, 'DB Shoulders',3,  8, 'times', 'Stand straight and slightly bend elbows; slowly upper arms sidewards until head level; hold 1 sec. and return and repeat');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (108, 'Chek press'                    , 'exicons/10.png', 1, 'DB Shoulders',3,  8, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (109, 'Front raise'                   , 'exicons/26.png', 1, 'DB Shoulders',3,  8, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (110, 'Seated press'                  , 'exicons/9.png' , 1, 'DB Shoulders',3,  8, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (111, 'Shoulder shrug'                , 'exicons/14.png', 1, 'DB Beg'      ,3,  8, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (107, 'Triceps extension'             , 'exicons/6.png' , 1, 'DB Triceps'  ,3,  8, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (112, 'One arm press'                 , 'exicons/5.png' , 1, 'DB Triceps'  ,3,  8, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (113, 'French press'                  , 'exicons/7.png' , 1, 'DB Triceps'  ,3,  8, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (115, 'Press on floor'                , 'exicons/25.png', 1, 'DB Chest'    ,3, 10, 'times', '');
