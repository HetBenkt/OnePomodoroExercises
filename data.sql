...
INSERT INTO days (title, description, date, exercises) VALUES ('Day 1', 'Start of the 3 days FULL-BODY exercises!', '2019-11-11', ARRAY[-2,-3,26,24,   201,          34,            102,       67,        40,     401,        18,        5,             501,        4,     44,    -30]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 2', 'Almost half way!', '2019-11-13'                        , ARRAY[-2,-3,28,24,   202,          71,            105,       68,        42,     404,        19,        6,              52,      301,     46,    -40]);
INSERT INTO days (title, description, date, exercises) VALUES ('Day 3', 'Finish the sequence as a pro!', '2019-11-15'           , ARRAY[-2,-3,25,24,   203,          76,            103,       69,        43,     403,        29,        7,             502,      302,     49,    -50]);
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES ( 7, 'Heel curl (L)/(R)'              , 'td_action_img/empty/icon.png'                      , 3, 'Hamstr.'           , 3, 10, 'times', 'Sit on floor; raise but and curl heels');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (26, 'BC Knees to Elbows'             , 'td_action_img/empty/icon.png'                      , 1, 'WARMING-UP'        , 1, 28, 'times', '');
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (28, 'BC Fake Jump Ropes'             , 'td_action_img/empty/icon.png'                      , 1, 'WARMING-UP'        , 1, 36, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (302, '1 x 10kg Dumbbell rows (L)/(R)'  , 'exicons/15.png'               , 1, 'DB Back'     ,3, 12, 'times', '');
...
INSERT INTO exercises (excelrow, name, image, weight, category, sets, reps, units, description) VALUES (502, '1 x 11kg Dumbbell pullover'      , 'exicons/7.png'                , 1, 'DB Chest'    ,3, 17, 'times', '');
